...
namespace Descent.Gameplay.Events.Arguments
{
    public class CollisionEventArgs : EventArgs
    {
        ...
        public Vector3 CollisionRelativeVelocity { get; private set; } = Vector3.zero;
        ...
        public CollisionEventArgs(Transform transform, Vector3 collisionPoint, Vector3 collisionNormal,
            Vector3 collisionRelativeVelocity, CollisionParameters collisionParameters, bool isTrigger)
        {
            Transform = transform;
            CollisionPoint = collisionPoint;
            CollisionNormal = collisionNormal;
            CollisionParameters = collisionParameters;
            CollisionRelativeVelocity = collisionRelativeVelocity;
            IsTrigger = isTrigger;
        }
    }
}